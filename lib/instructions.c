...
// Needs to be fixed
//Array of all instruction types with the size of 0x100
instruction instructions[0x100] = {
    //NOP  , implied addressing mode
    [0x00] = {IN_NOP}, //***I DONT THINK I NEED TO PUT AM_IMP CHANGE IT LATER***
    
    //Load, use register and a 16 bit number, register type BC
    ...
    //Decremenet, adressing mode is simple tegister, register type B
    ...
    //Load instrctuion, addressing mode D8 to register, register type C
    ...
    //Jump, 16 bit address adressing mode
    [0xC3] = {IN_JP, AM_D16},
    ...
    [0xF3] = {IN_DI},     //Disable interrupts, implied adressing mode
...
//returns address of instructions at opcode
...
//To loop up instruction and get a string name for it
char *inst_lookup[] = {
    "<NONE>",
    "NOP",
    "LD",
